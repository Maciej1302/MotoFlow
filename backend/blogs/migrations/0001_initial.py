        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "author_name",
                    models.CharField(
                        help_text="Name of the author of the blog post",
                        max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Comments related to the blog post",
                        null=True,
                ...
                (
                    ...
                    models.OneToOneField(
                        help_text="Detailed content of the blog",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="blog",
                        to="blogs.blogcontent",
                        verbose_name="Blog Content",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blog_content",
                    models.ForeignKey(
                        help_text="The blog post this image belongs to",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="images",
                        to="blogs.blogcontent",
                        verbose_name="Blog Content",
